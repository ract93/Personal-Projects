...
1. Most of the program tested except for initCommands() on the highest level within library.h/.cpp handles parsing
...
2. A Hash table is implemented in PatronHashTable .h/.cpp that is used to store patrons. 
